...
EnergyScaleCorrection::EnergyScaleCorrection(TString correctionFileName, 
...
float EnergyScaleCorrection::getScaleOffset(int runNumber, bool isEBEle, double R9Ele, double etaSCEle, double EtEle){
...
void EnergyScaleCorrection::Add(TString category_, int runMin_, int runMax_, double deltaP_, double err_deltaP_){
...
TTree *EnergyScaleCorrection::GetCorrTree(TChain *tree, bool fastLoop, 
...
//============================== SMEARING
void EnergyScaleCorrection::AddSmearing(TString category_, int runMin_, int runMax_, 
...
void EnergyScaleCorrection::ReadSmearingFromFile(TString filename){
#ifdef SHERVIN
...
float EnergyScaleCorrection::getSmearingSigma(int runNumber, float energy, bool isEBEle, float R9Ele, float etaSCEle){
...
float EnergyScaleCorrection::getSmearing(int runNumber, float energy, bool isEBEle, float R9Ele, float etaSCEle){
...
TTree *EnergyScaleCorrection::GetSmearTree(TChain *tree, bool fastLoop, 
...
float EnergyScaleCorrection::ScaleCorrection(int runNumber, bool isEBEle, 
...
float EnergyScaleCorrection::GetMean_nPV(TChain *tree, bool fastLoop, 
                                                TString nPVBranchName
					       ){
  float nPVmean=0;
  Int_t nPV_;
