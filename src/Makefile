...
CXX  =  c++
CXXFLAGS  =  -Wall -O -fPIC -I$(HDR) $(ROOTCFLAGS) -I$(ROOFITSYS)/include
CPP  =  c++
CPPFLAGS  = -Wall $(ARCHL) -I$(HDR) $(ROOTCFLAGS) -I$(ROOFITSYS)/include
...
GLIBS   =  -lm -ldl -rdynamic $(ROOTGLIBS) -L$(ROOFITSYS)/lib -lGenVector -lFoam -lMinuit -lRooFitCore -lRooFit -lMLP -lXMLIO -lTMVA -lTreePlayer
